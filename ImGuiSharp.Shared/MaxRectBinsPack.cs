namespace ImGui
{
    ...
    */
    ...
    internal class MaxRectsBinPack
    {
        ...
        public List<ImRect> usedRectangles = new List<ImRect>();
        public List<ImRect> freeRectangles = new List<ImRect>();
        ...
        ImRect FindPositionForNewNodeBestShortSideFit(int width, int height, ref int bestShortSideFit, ref int bestLongSideFit)
        {
            ImRect bestNode = new ImRect();
            //memset(&bestNode, 0, sizeof(ImRect));
        ...
        ImRect FindPositionForNewNodeBestLongSideFit(int width, int height, ref int bestShortSideFit, ref int bestLongSideFit)
        {
            ImRect bestNode = new ImRect();
            //memset(&bestNode, 0, sizeof(ImRect));
