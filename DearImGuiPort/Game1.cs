...
namespace ImGui.MonoGame.NET
{
    ...
    public class Game1 : Game
    {
        ...
        private void DrawTriangle(Vector3 p0, Vector3 p1, Vector3 p2)
        {
            ...
            verts[0] = new VertexPositionColorTexture(p0, Color.Red, new Vector2(0, 0));
            verts[1] = new VertexPositionColorTexture(p1, Color.Blue, new Vector2(1, 0));
            verts[2] = new VertexPositionColorTexture(p2, Color.Green, new Vector2(1, 1));
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            for (var k = 0; k < data.CmdListsCount; k++)
            {
                ...
                for (var i = 0; i < drawlist.VtxBuffer.Size; i++)
                {
                    ...
                    var uv = new Vector2(v.uv.x, v.uv.y);
